...
const s = {
  ...
  cta: "hidden md:inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 font-heading text-base tracking-wider hover:bg-primary/90 transition-colors",
